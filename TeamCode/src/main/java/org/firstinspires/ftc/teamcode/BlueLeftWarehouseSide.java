...
@Autonomous(name = "BlueLeftWarehouseSide", group = "11697")

public class BlueLeftWarehouseSide extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            driveByEncoder(0.75,2,0);
            driveByEncoder(0.5,-2,-2);
            driveByEncoder(0.75, 4.25,-4.25);
            driveByEncoder(0.75,-6.4, -6.4);

            //don't need switch since place() changes depending on duckpos
            place();

            driveByEncoder(0.75,2.5,0);
            driveByEncoder(0.75,7.9,-7.9);
            robot.FlipperJohn.setPosition(0.673);
            driveByEncoder(0.75, 2.5,0);
            //drive into warehouse
            driveByEncoder(0.5, 8.7,8.7);
            sleep(100);
            driveByEncoder(0.5,0,4);
            driveByEncoder(0.5,3.25,0);
            driveByEncoder(0.5,23,23);
