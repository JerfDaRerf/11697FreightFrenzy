...
@Autonomous(name = "RedLeftDuckSide", group = "11697")

public class RedLeftDuckSide extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (duckpos.equals("right")) {
                ...
                sleep(50);
                driveByEncoder(0.75, 5.3, -5.3);
                driveByEncoder(.75,-5.2,-5.2);
                place();

                driveByEncoder(0.75,2.5,-2.5);
                driveByEncoder(1, 10.75,10.75);
                driveByEncoder(0.5,6.5,6.5);
                driveByEncoder(0.25,2.65,2.65);
                //turn duck carousel
                turnDuck("red");

            } else {
                driveByEncoder(1,-2.5,-2.5);
                driveByEncoder(0.75, 4.85,-4.85);
                driveByEncoder(1,-7.45,-7.45);

                //don't need switch since place() changes depending on duckpos
                place();

                driveByEncoder(0.76, 4, -4);
                driveByEncoder(1,15,15);
                driveByEncoder(0.5,4.6,4.6);

//                driveByEncoder(0.75,3.6,-3.6);
//                driveByEncoder(1, 12,12);
//                driveByEncoder(0.5,5.55,5.55);
//                driveByEncoder(0.25,2.5,2.5);
                //turn duck carousel
                turnDuck("red");

//                //park at storage unit
//                driveByEncoder(1, -1, -1);
//                driveByEncoder(1,-2.5,2.5);
//                driveByEncoder(1,0,5);

            }

//            driveByEncoder(1,-4,-4);
//            driveByEncoder(1,3.55,-3.55);
//            driveByEncoder(0.5,6.5,0);
//            sleep(100);
//            driveByEncoder(0.35,0,15.5);
//            driveByEncoder(1,4.5,4.5);

            driveByEncoder(1,-4,-4);
            driveByEncoder(1,3.67,-3.67);
            driveByEncoder(1,-2,-2, "1");
            driveByEncoder(0.5,6.5,0, "2");

            driveByEncoder(0.5,0,2, "3");
            driveByEncoder(1,-5,-5, "4");
            driveByEncoder(0.5,4,0);
            driveByEncoder(0.5,0,2);
            driveByEncoder(1,2.2,2.2);
            driveByEncoder(0.5,4,0);

            sleep(100);
            driveByEncoder(0.35,0,15.2);
            driveByEncoder(1,9,9);
